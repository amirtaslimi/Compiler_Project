...
{
      13,     0,    -1,    14,    -1,    13,    14,    -1,    15,     8,
      -1,    15,     4,    16,    -1,    15,     5,    16,    -1,    16,
      -1,    16,     6,    17,    -1,    16,     7,    17,    -1,    17,
      -1,    10,    15,    11,    -1,     3,    -1
};
...
static const char *const yytname[] =
{
  ...
  "UMINUS", "'('", "')'", "$accept", "start", "expr", "add", "term",
  "factor", 0
};
#endif
...
{
       9,    11,    12,     1,     1,    14,    15,     8,    16,    10,
       2,     2,    11,    12,    17,    18,    13,     0,    19,    20
};

static const yytype_int8 yycheck[] =
{
       0,     4,     5,     3,     3,     6,     7,     2,    11,     3,
      10,    10,     4,     5,    11,    12,     8,    -1,    14,    15
};
...
{
       0,     3,    10,    13,    14,    15,    16,    17,    15,     0,
      14,     4,     5,     8,     6,     7,    11,    16,    16,    17,
      17
};
...
/* Line 1455 of yacc.c  */
#line 70 "parsercode.y"
    { strcpy((yyval.nonTerminal), (yyvsp[(1) - (2)].nonTerminal)); ;}
    break;

  case 5:

/* Line 1455 of yacc.c  */
#line 73 "parsercode.y"
    { sprintf((yyval.nonTerminal), "t%d", counter++); printf("%s = %s + %s;\n", (yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), (yyvsp[(3) - (3)].nonTerminal)); calculate((yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), "+", (yyvsp[(3) - (3)].nonTerminal));;}
    break;

  case 6:

/* Line 1455 of yacc.c  */
#line 74 "parsercode.y"
    { sprintf((yyval.nonTerminal), "t%d", counter++); printf("%s = %s - %s;\n", (yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), (yyvsp[(3) - (3)].nonTerminal)); calculate((yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), "-", (yyvsp[(3) - (3)].nonTerminal));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 75 "parsercode.y"
    { strcpy((yyval.nonTerminal), (yyvsp[(1) - (1)].nonTerminal));;}
    break;

  case 8:

/* Line 1455 of yacc.c  */
#line 78 "parsercode.y"
    { sprintf((yyval.nonTerminal), "t%d", counter++); printf("%s = %s * %s;\n", (yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), (yyvsp[(3) - (3)].nonTerminal));calculate((yyval.nonTerminal), (yyvsp[(1) - (3)].nonTerminal), "*", (yyvsp[(3) - (3)].nonTerminal)); ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 84 "parsercode.y"
    { strcpy((yyval.nonTerminal), (yyvsp[(1) - (1)].num)); ;}
    break;



/* Line 1455 of yacc.c  */
#line 1433 "parsercode.tab.c"
      default: break;
    }
